...
#  Nov 24, 2020 02:00:15 PM EST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    wm geometry $top 600x450+875+155
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    entry $top.ent51 \
        ...
        -selectforeground white -textvariable profilename -width 10 
    ...
    ttk::combobox $top.tCo44 \
        -values {casual hardcore RPGonly kids killingtime {} {}} \
    ...
    ###################
    place $top.lab45 \
        -in $top -x 0 -relx 0.15 -y 0 -rely 0.156 -width 0 -relwidth 0.453 \
    ...
    place $top.tCo45 \
        ...
        -height 0 -relheight 0.058 -anchor nw -bordermode ignore 
    place $top.tCo46 \
        -in $top -x 0 -relx 0.483 -y 0 -rely 0.778 -width 0 -relwidth 0.312 \
        -height 0 -relheight 0.058 -anchor nw -bordermode ignore 
